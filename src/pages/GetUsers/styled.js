...
export const Post = styled.div`
  ...
  border-radius: 5px;
  background-color: ${(props) => props.deleted ? 'rgba(255, 0, 0, 0.3)' : props.theme.color.first5Alpha};
  cursor: pointer;

  &:hover {
    background-color: ${(props) => props.deleted ? 'hsla(6, 51%, 29%, 1)' : props.theme.color.secondOpacity03};
  }
`;
...
export const UserLoggedBall = styled.div`
  ...
  display: inline-block;
  margin-bottom: 3px;
  box-shadow: 2px 2px 5px ${({ theme }) => theme.color.firstBg};
  cursor: pointer;
`;